...
| **Server Members Intent** | Yes | Search users by name in admin commands |
...
> Admin commands use natural language processed by LLM. Examples:
> - "Timeout user 'John' for 1 hour"
